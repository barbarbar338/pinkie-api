...
async function bootstrap() {
    ...
    /*
        ...
        Ancak bir index sayfamızda da işlem yapmak istiyoruz
        ...
        Kısacası aşağıdaki 1 satır kodu kaldırıp tüm controllerlere "config.API_VERSION" prefixini eklemem lazım
